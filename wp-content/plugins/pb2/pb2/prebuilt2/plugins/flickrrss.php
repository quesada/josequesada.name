...
function get_flickrRSS() {
	...
	// get the feeds
	if ($type == "public") { $rss_url = 'http://www.flickr.com/services/feeds/photos_public.gne?tags=' . $tags . '&format=rss_200'; }
	elseif ($type == "user") { $rss_url = 'http://www.flickr.com/services/feeds/photos_public.gne?id=' . $userid . '&tags=' . $tags . '&format=rss_200'; }
	elseif ($type == "group") { $rss_url = 'http://www.flickr.com/groups/' . $userid . '/pool/feed/?format=rss_200'; }
	else { print "flickrRSS is not configured properly"; }
